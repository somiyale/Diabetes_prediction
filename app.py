...
input_data = pd.DataFrame([{
    ...
    "bmi_category_Obese": int(bmi_obese),
    "bmi_category_Overweight": int(bmi_overweight),
    "bmi_category_Underweight": int(bmi_underweight)
}], columns=[
    'gender', 'age', 'hypertension', 'heart_disease', 'smoking_history', 'bmi',
    'HbA1c_level', 'blood_glucose_level', 'age_bmi_interaction',
    'glucose_hba1c_interaction', 'age_group_Adult', 'age_group_Senior',
    'age_group_Elder', 'bmi_category_Obese', 'bmi_category_Overweight',
